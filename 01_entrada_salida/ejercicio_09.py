...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        float_sueldo = float(txt_sueldo)
        float_incremento = float(txt_incremento)
        
        float_calcular_incremento = (float_sueldo * float_incremento) / 100
        float_nuevo_sueldo =  float_sueldo + float_calcular_incremento

        txt_nuevo_sueldo = str(float_nuevo_sueldo)
    

        mensaje = ("Tu sueldo actualizado es de: " + "$" + txt_nuevo_sueldo)
        alert(title="Sueldo con incremento", message=mensaje)
