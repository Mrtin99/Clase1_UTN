...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        float_importe = float(txt_importe)
        float_descuento = float(txt_descuento)
        
        float_calcular_descuento =  float_importe * (float_descuento / 100)
        float_importe_actualizado =  float_importe - float_calcular_descuento

        txt_importe_actualizado = str(float_importe_actualizado)
    

        mensaje = ("Tu importe actualizado es de: " + "$" + txt_importe_actualizado)
        alert(title="Importe con descuento", message=mensaje)
