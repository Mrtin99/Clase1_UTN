...
class App(customtkinter.CTk):
    ...
    def btn_validar_letra_on_click(self):
        letra = prompt("Validar letra", "Ingreso una letra en mayuscula")
        letra = str(letra)

        while letra != "U" and letra != "T" and letra != "N":
            alert(title="Letra incorrecta", message="Ingresaste la letra incorrecta, por favor volver a ingresar")
            letra = prompt("Validar letra", "Ingreso una letra en mayuscula")
            letra = str(letra)

        alert(title="Letra correcta", message="Ingresaste la letra correcta")
